...
class _$ArtistImpl implements _Artist {
  ...
  @override
  String toString() {
    return 'Artist(id: $id, name: $name, trackCount: $trackCount, albumCount: $albumCount, imagePath: $imagePath)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, trackCount, albumCount, imagePath);
